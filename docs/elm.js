...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		...
		author$project$Main$fetchJson(1560463226000));
};
								...
								_List_fromArray(
									[
										...
										function (remainFloat) {
											...
											var strHours = elm$core$String$fromInt((remainInt / 3600) | 0);
											var strMinutes = elm$core$String$fromInt(
												(A2(elm$core$Basics$modBy, 3600, remainInt) / 60) | 0);
											var strSeconds = elm$core$String$fromInt(
												A2(
